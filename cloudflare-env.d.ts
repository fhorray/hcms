/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 9bef3517d65222a1a5186915b2924a54)
...
declare namespace Cloudflare {
	interface Env {
		...
		OPACA_SECRET: string;
		OPACA_DB_URL: string;
		OPACA_DB_TARGET: string;
		OPACA_DB_DIALECT: string;
		OPACA_BASE_URL: string;
		DB: D1Database;
		ASSETS: Fetcher;
	}
}
